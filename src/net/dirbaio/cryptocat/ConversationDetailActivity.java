...
public class ConversationDetailActivity extends FragmentActivity
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		if (savedInstanceState == null)
		{
			...
			arguments.putString(MainActivity.ARG_CONVERSATION_ID,
					getIntent().getStringExtra(MainActivity.ARG_CONVERSATION_ID));
			arguments.putString(MainActivity.ARG_SERVER_ID,
					getIntent().getStringExtra(MainActivity.ARG_SERVER_ID));
