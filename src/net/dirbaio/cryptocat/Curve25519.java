...
public class Curve25519
{
     ...
     * parallel to) hashing the item_message.
     */
    /* Signature generation primitive, calculates (x-h)s mod q
     *   v  [out] signature value
     *   h  [in]  signature hash (of item_message, signature pub key, and context data)
	...
	public static void verify(byte[] Y, byte[] v, byte[] h, byte[] P)
	{
		...
		long10[] p = new long10[]
				...
				yx = new long10[]
						{
								new long10(), new long10(), new long10()
						},
				yz = new long10[]
						{
								new long10(), new long10(), new long10()
